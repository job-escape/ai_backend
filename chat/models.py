...
class EditorObject(models.Model):
    # chat before was task
    chat = models.ForeignKey(Chat, verbose_name=_("Task"), related_name="objs", on_delete=models.CASCADE)
...
class Message(models.Model):
    # chat before was task
    chat = models.ForeignKey(Chat, verbose_name=_("Task"), related_name="messages", on_delete=models.CASCADE)
